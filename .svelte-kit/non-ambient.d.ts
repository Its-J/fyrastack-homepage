...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/api" | "/api/prereserve" | "/docs" | "/mockup" | "/services" | "/services/colocation" | "/services/vps";
		RouteParams(): {
